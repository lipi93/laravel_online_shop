                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Name" {{ $subCategory->name }}>
                            <p></p>
                        </div>                       
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" id="slug" class="form-control" placeholder="Slug" {{ $subCategory->slug }}>
                            <p></p>	
                        </div>
                    </div>
                    <div class="col-md-6">
